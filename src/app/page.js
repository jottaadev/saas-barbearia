...
import { Clock, Phone, MapPin, MessageCircle, ArrowDown } from 'lucide-react';
import axios from 'axios';

// As funções de busca de dados permanecem as mesmas
...
// Componente da Nova Landing Page
      ...
      <section id="localizacao" className="py-28 px-6 bg-black">
        <div className="max-w-5xl mx-auto animate-slide-up-fade-in">
            <div className="text-center mb-16">
                <h2 className="font-display font-bold text-4xl sm:text-5xl text-white">Nosso Espaço</h2>
                <p className="text-zinc-400 mt-4 max-w-xl mx-auto">
                    Um ambiente moderno e confortável, projetado para você relaxar enquanto cuidamos do seu estilo.
                </p>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-0 bg-zinc-950 border border-zinc-800 rounded-xl overflow-hidden">
                <div className="lg:col-span-3 h-80 lg:h-[500px]">
                  <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3657.197574883467!2d-46.65882238493442!3d-23.5613393675464!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce59c8da0aa315%3A0xd59f9431f2c97763!2sAv.%20Paulista%2C%20S%C3%A3o%20Paulo%20-%20SP!5e0!3m2!1spt-BR!2sbr!4v1678886567654!5m2!1spt-BR!2sbr"
                    width="100%" 
                    height="100%" 
                    style={{ border:0 }} 
                    allowFullScreen="" 
                ...
                <div className="lg:col-span-2 p-8 lg:p-10 flex flex-col justify-center space-y-8 bg-black">
                  <div>
                  ...
                  <div>
                    ...
                    <p className="pl-8 text-zinc-300 text-sm">Av. Principal, 123 - Centro</p>
                  </div>
                   <div className="pt-4">
                        <a 
